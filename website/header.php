...
function loadcontentmain(data){

	xmlhttp = new XMLHttpRequest();
	data = data+"?param="+new Date().getTime();
	xmlhttp.open("GET",data,false);
	//	alert(data);
	xmlhttp.send();
	document.getElementById('single-post').innerHTML = xmlhttp.responseText;
...
<body>
<div id="top-bar" style="text-align:right; font-size:14px">Welcome&nbsp; <?php echo $_SESSION['INSUSER']; ?>&nbsp;&nbsp;&nbsp;</div>
<!-- header div start-->
<div id="header">
	<div id="logo"><a href="contest"><?php echo $site_name; ?></a></div>
	...
	<div id="nav">
		...
		<ul class="sf-menu">
			...
			<li><a href="#">Problems</a>
				<ul>
					<!--level 2-->
                    <?php for($i=1;$i<=$num_probs;$i++){
						print '<li><a href="question'.$i.'">Problem '.$i.'</a></li>';
					} ?>
				</ul>
			</li>
			<li><a href="broadcast">Announcements</a></li>
			<li><a href="result">Results</a></li>
			<li><a href="submission">My submissions</a></li>
